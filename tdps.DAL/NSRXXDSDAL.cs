...
namespace tdps.DAL
{
	...
	public partial class NSRXXDSDAL
	{
		...
		public bool Exists(string NSRSBH)
		{
			...
			strSql.Append("select count(NSRSBH) from NSRXXDS");
		...
		public void Add(tdps.Model.NSRXXDS model)
		{
			...
			strSql.Append("NSRSBH,SSHY,SSYH,QYDJZCL,NSLX,SFTYHSJG,ZGSWJG,ZGSWJG_MC,NSR_SWJG_DM,JKBZ,XY,LSGX,NSRBM,NSRZT,ZGY)");
		...
		public void Delete(string NSRSBH)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from NSRXXDS ");
			strSql.Append(" where NSRSBH=@NSRSBH ");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@NSRSBH", DbType.String,50)};
			parameters[0].Value = NSRSBH;
		...
		public tdps.Model.NSRXXDS GetModel(string NSRSBH)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select NSRSBH,SSHY,SSYH,QYDJZCL,NSLX,SFTYHSJG,ZGSWJG,ZGSWJG_MC,NSR_SWJG_DM,JKBZ,XY,LSGX,NSRBM,NSRZT,ZGY,SSHY_MC,QYDJZCL_MC,LSGX_MC from NSRXXDS ");
			strSql.Append(" where NSRSBH=@NSRSBH ");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@NSRSBH", DbType.String,50)};
			parameters[0].Value = NSRSBH;

			tdps.Model.NSRXXDS model=new tdps.Model.NSRXXDS();
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select NSRSBH,SSHY,SSYH,QYDJZCL,NSLX,SFTYHSJG,ZGSWJG,ZGSWJG_MC,NSR_SWJG_DM,JKBZ,XY,LSGX,NSRBM,NSRZT,ZGY,SSHY_MC,QYDJZCL_MC,LSGX_MC ");
			strSql.Append(" FROM NSRXXDS ");
			if(strWhere.Trim()!="")
			{
