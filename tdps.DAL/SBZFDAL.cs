...
namespace tdps.DAL
{
	...
	public partial class SBZFDAL
	{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select FID,SBXXID,HZLX,NSRSBH,NSRMC,SWJGMC,SBZFFSSJ,SBZFCLSJ,JYLSH,DZYZData,SBWJ,SBZL,SBSJ,SBSE,TSXX,SBZLMC,SBCS,SSQQ,SSQZ,FKDM,FKXX,SBZFSJ,MW,SZ,FileName ");
			strSql.Append(" FROM SBZF ");
			if(strWhere.Trim()!="")
			{
