...
namespace tdps.DAL
{
	...
	public partial class SBCLDAL
	{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select FID,SBXXID,HZLX,NSRSBH,NSRMC,SWJGMC,SBFSSJ,SBCLSJ,JYLSH,JMM,DZYZData,SBWJ,SBBZLMC,SBZL,SBSE,TSXX,SBCS,SSQQ,SSQZ,MW,SZ,FKDM,FKXX,FKSJ,FileName ");
			strSql.Append(" FROM SBCL ");
			if(strWhere.Trim()!="")
			{
