...
namespace tdps.DAL
{
	...
	public partial class NSRXXGSDAL
	{
        ...
        public void Add(tdps.Model.NSRXXGS model, object trans)
		{
            ...
            strSql.Append("NSRSBH,SSHY,SSYH,QYDJZCL,NSLX,SFTYHSJG,ZGSWJG,ZGSWJG_MC,NSR_SWJG_DM,JKBZ,XY,LSGX,NSRBM,NSRZT,ZGY,SSHY_MC,QYDJZCL_MC,LSGX_MC,NSRZT_MC,nsrzg_dm)");
            ...
            SQLiteParameter[] parameters = {
                    ...
                    new SQLiteParameter("@nsrzg_dm", DbType.String,20)};
            ...
            parameters[18].Value = model.NSRZT_MC;
            parameters[19].Value = model.nsrzg_dm;
        ...
        public void Update(tdps.Model.NSRXXGS model, object trans)
		{
            ...
            strSql.Append("nsrzg_dm=@nsrzg_dm");
